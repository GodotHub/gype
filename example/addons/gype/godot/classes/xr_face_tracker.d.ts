...
export declare class XRFaceTracker extends XRTracker {
    ...
    public blend_shapes: PackedFloat32Array;
    public get_blend_shape(blendShape: number): number;
    public set_blend_shape(blendShape: number, weight: number): void;
    public get_blend_shapes(): PackedFloat32Array;
    public set_blend_shapes(weights: PackedFloat32Array): void;


    public static readonly BlendShapeEntry: {
