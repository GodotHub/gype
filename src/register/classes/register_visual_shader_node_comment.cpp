...
static void define_visual_shader_node_comment_enum(JSContext *ctx, JSValue ctor) {
}
...
static int js_visual_shader_node_comment_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_visual_shader_node_comment_enum(ctx, ctor);
	JS_SetConstructor(ctx, ctor, proto);
	JS_SetModuleExport(ctx, m, "VisualShaderNodeComment", ctor);
	ctor_list["VisualShaderNodeComment"] = ctor;
