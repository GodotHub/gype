...
static void js_init_packed_int32_array_module(JSContext *ctx) {
...
static JSClassDef packed_int32_array_proxy_def = {
	"PackedInt32ArrayProxy",
	packed_int32_array_proxy_finalizer
};
...
static JSValue packed_int32_array_proxy_get(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    ...
    ObjectProxy<PackedInt32Array> *proxy = static_cast<ObjectProxy<PackedInt32Array> *>(opaque);
