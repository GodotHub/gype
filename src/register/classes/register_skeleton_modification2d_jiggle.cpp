...
static void define_skeleton_modification2d_jiggle_enum(JSContext *ctx, JSValue ctor) {
}
...
static int js_skeleton_modification2d_jiggle_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_skeleton_modification2d_jiggle_enum(ctx, ctor);
	JS_SetConstructor(ctx, ctor, proto);
	JS_SetModuleExport(ctx, m, "SkeletonModification2DJiggle", ctor);
	ctor_list["SkeletonModification2DJiggle"] = ctor;
