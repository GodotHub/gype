...
static void define_visual_shader_node_expression_enum(JSContext *ctx, JSValue ctor) {
}
...
static int js_visual_shader_node_expression_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_visual_shader_node_expression_enum(ctx, ctor);
	JS_SetConstructor(ctx, ctor, proto);
	JS_SetModuleExport(ctx, m, "VisualShaderNodeExpression", ctor);
	ctor_list["VisualShaderNodeExpression"] = ctor;
