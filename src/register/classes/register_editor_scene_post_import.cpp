...
static void define_editor_scene_post_import_enum(JSContext *ctx, JSValue ctor) {
}
...
static int js_editor_scene_post_import_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_editor_scene_post_import_enum(ctx, ctor);
	JS_SetConstructor(ctx, ctor, proto);
	JS_SetModuleExport(ctx, m, "EditorScenePostImport", ctor);
	ctor_list["EditorScenePostImport"] = ctor;
