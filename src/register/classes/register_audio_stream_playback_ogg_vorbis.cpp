...
static void define_audio_stream_playback_ogg_vorbis_enum(JSContext *ctx, JSValue ctor) {
}
...
static int js_audio_stream_playback_ogg_vorbis_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_audio_stream_playback_ogg_vorbis_enum(ctx, ctor);
	JS_SetConstructor(ctx, ctor, proto);
	JS_SetModuleExport(ctx, m, "AudioStreamPlaybackOggVorbis", ctor);
	ctor_list["AudioStreamPlaybackOggVorbis"] = ctor;
