...
static void define_physics_direct_space_state2d_extension_enum(JSContext *ctx, JSValue ctor) {
}
...
static int js_physics_direct_space_state2d_extension_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_physics_direct_space_state2d_extension_enum(ctx, ctor);
	JS_SetConstructor(ctx, ctor, proto);
	JS_SetModuleExport(ctx, m, "PhysicsDirectSpaceState2DExtension", ctor);
	ctor_list["PhysicsDirectSpaceState2DExtension"] = ctor;
