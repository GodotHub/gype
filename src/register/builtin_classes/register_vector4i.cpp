...
static void js_init_vector4i_module(JSContext *ctx) {
...
static JSValue vector4i_proxy_min_axis_index(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    ...
    ObjectProxy<Vector4i> *proxy = static_cast<ObjectProxy<Vector4i> *>(opaque);
