...
static JSClassDef visual_shader_node_float_constant_class_def = {
    ...
    visual_shader_node_float_constant_class_finalizer
};
...
static int js_visual_shader_node_float_constant_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	classes["VisualShaderNodeFloatConstant"] = class_id;
	classes_by_id[class_id] = "VisualShaderNodeFloatConstant";
	JS_NewClass(JS_GetRuntime(ctx), class_id, &visual_shader_node_float_constant_class_def);
...
void __register_visual_shader_node_float_constant() {
	js_init_visual_shader_node_float_constant_module(js_context());
}

void register_visual_shader_node_float_constant() {
	__register_visual_shader_node_float_constant();
}