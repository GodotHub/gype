...
export declare class NativeMenu extends GodotObject {
    ...
    public set_popup_open_callback(rid: RID, callback: Callable): void;
    public get_popup_open_callback(rid: RID): Callable;
    public set_popup_close_callback(rid: RID, callback: Callable): void;
    ...
    public add_item(rid: RID, label: GDString | StringName | string, callback: Callable = Callable(), keyCallback: Callable = Callable(), tag: any = null, accelerator: number = 0, index: number = -1): number;
    public add_check_item(rid: RID, label: GDString | StringName | string, callback: Callable = Callable(), keyCallback: Callable = Callable(), tag: any = null, accelerator: number = 0, index: number = -1): number;
    public add_icon_item(rid: RID, icon: Texture2D, label: GDString | StringName | string, callback: Callable = Callable(), keyCallback: Callable = Callable(), tag: any = null, accelerator: number = 0, index: number = -1): number;
    public add_icon_check_item(rid: RID, icon: Texture2D, label: GDString | StringName | string, callback: Callable = Callable(), keyCallback: Callable = Callable(), tag: any = null, accelerator: number = 0, index: number = -1): number;
    public add_radio_check_item(rid: RID, label: GDString | StringName | string, callback: Callable = Callable(), keyCallback: Callable = Callable(), tag: any = null, accelerator: number = 0, index: number = -1): number;
    public add_icon_radio_check_item(rid: RID, icon: Texture2D, label: GDString | StringName | string, callback: Callable = Callable(), keyCallback: Callable = Callable(), tag: any = null, accelerator: number = 0, index: number = -1): number;
    public add_multistate_item(rid: RID, label: GDString | StringName | string, maxStates: number, defaultState: number, callback: Callable = Callable(), keyCallback: Callable = Callable(), tag: any = null, accelerator: number = 0, index: number = -1): number;
    ...
    public set_item_callback(rid: RID, idx: number, callback: Callable): void;
    public set_item_hover_callbacks(rid: RID, idx: number, callback: Callable): void;
    public set_item_key_callback(rid: RID, idx: number, keyCallback: Callable): void;
