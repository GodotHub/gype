...
static void define_skeleton_modification2d_two_bone_ik_enum(JSContext *ctx, JSValue ctor) {
}
...
static int js_skeleton_modification2d_two_bone_ik_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_skeleton_modification2d_two_bone_ik_enum(ctx, ctor);
	JS_SetConstructor(ctx, ctor, proto);
	JS_SetModuleExport(ctx, m, "SkeletonModification2DTwoBoneIK", ctor);
	ctor_list["SkeletonModification2DTwoBoneIK"] = ctor;
