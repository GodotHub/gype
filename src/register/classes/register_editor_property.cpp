...
static JSValue editor_property_class_get_label(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	...
	proxy->getter = [this_val]() -> String {
		EditorProperty *obj = static_cast<EditorProperty *>(VariantAdapter(this_val).get().operator Object*());
		return obj->get_label();
	};
	proxy->setter = [this_val](const String &value) -> void {
		EditorProperty *js_proxy = static_cast<EditorProperty *>(VariantAdapter(this_val).get().operator Object *());
