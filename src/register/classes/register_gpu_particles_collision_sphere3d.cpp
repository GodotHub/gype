...
static void define_gpu_particles_collision_sphere3d_enum(JSContext *ctx, JSValue ctor) {
}
...
static int js_gpu_particles_collision_sphere3d_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_gpu_particles_collision_sphere3d_enum(ctx, ctor);
	JS_SetConstructor(ctx, ctor, proto);
	JS_SetModuleExport(ctx, m, "GPUParticlesCollisionSphere3D", ctor);
	ctor_list["GPUParticlesCollisionSphere3D"] = ctor;
