...
export declare class WorkerThreadPool extends GodotObject {
    ...
    public add_task(action: Callable, highPriority: boolean = false, description: GDString | StringName | string = ""): number;
    ...
    public add_group_task(action: Callable, elements: number, tasksNeeded: number = -1, highPriority: boolean = false, description: GDString | StringName | string = ""): number;
