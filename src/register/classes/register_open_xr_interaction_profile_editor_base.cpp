...
static void define_open_xr_interaction_profile_editor_base_enum(JSContext *ctx, JSValue proto) {
}
...
static int js_open_xr_interaction_profile_editor_base_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_open_xr_interaction_profile_editor_base_enum(ctx, proto);
