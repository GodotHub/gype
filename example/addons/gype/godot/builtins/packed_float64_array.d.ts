...
export declare class PackedFloat64Array {
    ...
    public append_array(array: PackedFloat64Array): void;
    ...
    public reverse(): void;
    public slice(begin: number, end: number): PackedFloat64Array;
    ...
    public equals(right: PackedFloat64Array): boolean;
    public not_equals(right: PackedFloat64Array): boolean;
    public add(right: PackedFloat64Array): PackedFloat64Array;
