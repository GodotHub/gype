...
export interface Vector3 {
    ...
    limitLength(length: number = 1.0): Vector3;
    normalized(): Vector3;
    ...
    cubicInterpolateInTime(b: Vector3, preA: Vector3, postB: Vector3, weight: number, bT: number, preAT: number, postBT: number): Vector3;
