...
export declare class _Performance extends GodotObject {
    ...
    public add_custom_monitor(id: GDString | StringName | string, callable: Callable | Function, arguments: GDArray | Array = []): void;
    ...
    public get_custom_monitor_names(): Array<any>;


    public static readonly Monitor: {
        TIME_FPS: 0;
        TIME_PROCESS: 1;
