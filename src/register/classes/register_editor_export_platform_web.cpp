...
static void define_editor_export_platform_web_enum(JSContext *ctx, JSValue ctor) {
}
...
static int js_editor_export_platform_web_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_editor_export_platform_web_enum(ctx, ctor);
	JS_SetConstructor(ctx, ctor, proto);
	JS_SetModuleExport(ctx, m, "EditorExportPlatformWeb", ctor);
	ctor_list["EditorExportPlatformWeb"] = ctor;
