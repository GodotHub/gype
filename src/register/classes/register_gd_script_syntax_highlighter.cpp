...
static void define_gd_script_syntax_highlighter_enum(JSContext *ctx, JSValue ctor) {
}
...
static int js_gd_script_syntax_highlighter_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_gd_script_syntax_highlighter_enum(ctx, ctor);
	JS_SetConstructor(ctx, ctor, proto);
	JS_SetModuleExport(ctx, m, "GDScriptSyntaxHighlighter", ctor);
	ctor_list["GDScriptSyntaxHighlighter"] = ctor;
