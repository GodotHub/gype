...
static void define_input_event_mouse_motion_enum(JSContext *ctx, JSValue ctor) {
}
...
static int js_input_event_mouse_motion_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_input_event_mouse_motion_enum(ctx, ctor);
	JS_SetConstructor(ctx, ctor, proto);
	JS_SetModuleExport(ctx, m, "InputEventMouseMotion", ctor);
	ctor_list["InputEventMouseMotion"] = ctor;
