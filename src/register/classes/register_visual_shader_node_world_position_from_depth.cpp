...
static void define_visual_shader_node_world_position_from_depth_enum(JSContext *ctx, JSValue ctor) {
}
...
static int js_visual_shader_node_world_position_from_depth_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_visual_shader_node_world_position_from_depth_enum(ctx, ctor);
