...
static JSClassDef navigation_server3d_class_def = {
	"_NavigationServer3D",
	navigation_server3d_class_finalizer
};

static JSValue navigation_server3d_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
	JSClassID class_id = classes["_NavigationServer3D"];
	JSValue obj = JS_NewObjectClass(ctx, class_id);
	if (JS_IsException(obj))
		return obj;

	NavigationServer3D *navigation_server3d_class = NavigationServer3D::get_singleton();
	if (!navigation_server3d_class) {
		JS_FreeValue(ctx, obj);
		return JS_EXCEPTION;
	}

	VariantAdapter *adapter = memnew(VariantAdapter(navigation_server3d_class));
...
static JSValue navigation_server3d_class_map_get_path(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_method_ret(&NavigationServer3D::map_get_path, ctx, this_val, argc, argv);
};
...
static JSValue navigation_server3d_class_map_set_use_async_iterations(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&NavigationServer3D::map_set_use_async_iterations, ctx, this_val, argc, argv);
	return JS_UNDEFINED;
};
static JSValue navigation_server3d_class_map_get_use_async_iterations(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&NavigationServer3D::map_get_use_async_iterations, ctx, this_val, argc, argv);
};
...
static JSValue navigation_server3d_class_query_path(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&NavigationServer3D::query_path, ctx, this_val, argc, argv);
	return JS_UNDEFINED;
};
...
static JSValue navigation_server3d_class_region_get_iteration_id(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&NavigationServer3D::region_get_iteration_id, ctx, this_val, argc, argv);
};
static JSValue navigation_server3d_class_region_set_use_async_iterations(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    call_builtin_method_no_ret(&NavigationServer3D::region_set_use_async_iterations, ctx, this_val, argc, argv);
	return JS_UNDEFINED;
};
static JSValue navigation_server3d_class_region_get_use_async_iterations(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&NavigationServer3D::region_get_use_async_iterations, ctx, this_val, argc, argv);
};
...
static JSValue navigation_server3d_class_region_get_closest_point_to_segment(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&NavigationServer3D::region_get_closest_point_to_segment, ctx, this_val, argc, argv);
};
static JSValue navigation_server3d_class_region_get_closest_point(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&NavigationServer3D::region_get_closest_point, ctx, this_val, argc, argv);
};
static JSValue navigation_server3d_class_region_get_closest_point_normal(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&NavigationServer3D::region_get_closest_point_normal, ctx, this_val, argc, argv);
};
...
static JSValue navigation_server3d_class_region_get_bounds(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&NavigationServer3D::region_get_bounds, ctx, this_val, argc, argv);
};
...
static JSValue navigation_server3d_class_link_get_iteration_id(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_const_method_ret(&NavigationServer3D::link_get_iteration_id, ctx, this_val, argc, argv);
};
...
static const JSCFunctionListEntry navigation_server3d_class_proto_funcs[] = {
	...
	JS_CFUNC_DEF("map_set_use_async_iterations", 2, &navigation_server3d_class_map_set_use_async_iterations),
	JS_CFUNC_DEF("map_get_use_async_iterations", 1, &navigation_server3d_class_map_get_use_async_iterations),
	JS_CFUNC_DEF("map_get_random_point", 3, &navigation_server3d_class_map_get_random_point),
	JS_CFUNC_DEF("query_path", 3, &navigation_server3d_class_query_path),
	JS_CFUNC_DEF("region_create", 0, &navigation_server3d_class_region_create),
	JS_CFUNC_DEF("region_get_iteration_id", 1, &navigation_server3d_class_region_get_iteration_id),
	JS_CFUNC_DEF("region_set_use_async_iterations", 2, &navigation_server3d_class_region_set_use_async_iterations),
	JS_CFUNC_DEF("region_get_use_async_iterations", 1, &navigation_server3d_class_region_get_use_async_iterations),
	...
	JS_CFUNC_DEF("region_get_closest_point_to_segment", 4, &navigation_server3d_class_region_get_closest_point_to_segment),
	JS_CFUNC_DEF("region_get_closest_point", 2, &navigation_server3d_class_region_get_closest_point),
	JS_CFUNC_DEF("region_get_closest_point_normal", 2, &navigation_server3d_class_region_get_closest_point_normal),
	JS_CFUNC_DEF("region_get_random_point", 3, &navigation_server3d_class_region_get_random_point),
	JS_CFUNC_DEF("region_get_bounds", 1, &navigation_server3d_class_region_get_bounds),
	JS_CFUNC_DEF("link_create", 0, &navigation_server3d_class_link_create),
	JS_CFUNC_DEF("link_get_iteration_id", 1, &navigation_server3d_class_link_get_iteration_id),
...
static int js_navigation_server3d_class_init(JSContext *ctx, JSModuleDef *m){
	...
	classes["_NavigationServer3D"] = class_id;
	JS_NewClass(JS_GetRuntime(ctx), class_id, &navigation_server3d_class_def);
	...
	JSValue ctor = JS_NewCFunction2(ctx, navigation_server3d_class_constructor, "_NavigationServer3D", 0, JS_CFUNC_constructor, 0);
	JS_SetConstructor(ctx, ctor, proto);


    JSValue singleton = JS_CallConstructor(ctx, ctor, 0, {});
	JS_SetModuleExport(ctx, m, "NavigationServer3D", singleton);
...
void register_navigation_server3d() {
	_js_init_navigation_server3d_module(js_context(), "@godot/classes/navigation_server3d");
}