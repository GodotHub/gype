...
static void input_event_mouse_button_class_finalizer(JSRuntime *rt, JSValue val) {
	JSClassID class_id = classes["InputEventMouseButton"];
...
static JSClassDef input_event_mouse_button_class_def = {
    ...
    input_event_mouse_button_class_finalizer
};
...
static JSValue input_event_mouse_button_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
    ...
    InputEventMouseButton *instance;
	VariantAdapter *adapter;
	JSClassID opaque_id;
    // Allow constructing from an existing native pointer
    if (argc == 1 && VariantAdapter::can_cast(argv[0], Variant::Type::OBJECT)) {
		adapter = static_cast<VariantAdapter *>(JS_GetAnyOpaque(*argv, &opaque_id));
		instance = static_cast<InputEventMouseButton *>(VariantAdapter(*argv).get().operator Object *());
    } else {
        instance = memnew(InputEventMouseButton);
...
static JSValue input_event_mouse_button_class_set_factor(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    ...
    return call_builtin_method_no_ret(&InputEventMouseButton::set_factor, ctx, this_val, argc, argv);
};
...
static JSValue input_event_mouse_button_class_set_button_index(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&InputEventMouseButton::set_button_index, ctx, this_val, argc, argv);
};
...
static JSValue input_event_mouse_button_class_set_pressed(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&InputEventMouseButton::set_pressed, ctx, this_val, argc, argv);
};
static JSValue input_event_mouse_button_class_set_canceled(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&InputEventMouseButton::set_canceled, ctx, this_val, argc, argv);
};
static JSValue input_event_mouse_button_class_set_double_click(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&InputEventMouseButton::set_double_click, ctx, this_val, argc, argv);
};
...
static void define_input_event_mouse_button_property(JSContext *ctx, JSValue proto) {
...
static void define_input_event_mouse_button_enum(JSContext *ctx, JSValue proto) {
}

static int js_input_event_mouse_button_class_init(JSContext *ctx, JSModuleDef *m) {	
	JSClassID class_id = 0;
	class_id = JS_NewClassID(js_runtime(), &class_id);
	classes["InputEventMouseButton"] = class_id;
	classes_by_id[class_id] = "InputEventMouseButton";
	JS_NewClass(JS_GetRuntime(ctx), class_id, &input_event_mouse_button_class_def);
	...
	define_input_event_mouse_button_enum(ctx, proto);
...
void __register_input_event_mouse_button() {
	js_init_input_event_mouse_button_module(js_context());
}

void register_input_event_mouse_button() {
	__register_input_event_mouse_button();
}