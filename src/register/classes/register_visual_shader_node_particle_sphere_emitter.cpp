...
static void define_visual_shader_node_particle_sphere_emitter_enum(JSContext *ctx, JSValue ctor) {
}
...
static int js_visual_shader_node_particle_sphere_emitter_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_visual_shader_node_particle_sphere_emitter_enum(ctx, ctor);
