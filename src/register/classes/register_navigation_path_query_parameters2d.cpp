...
static void navigation_path_query_parameters2d_class_finalizer(JSRuntime *rt, JSValue val) {
	JSClassID class_id = classes["NavigationPathQueryParameters2D"];
...
static JSClassDef navigation_path_query_parameters2d_class_def = {
    ...
    navigation_path_query_parameters2d_class_finalizer
};
...
static JSValue navigation_path_query_parameters2d_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
    ...
    NavigationPathQueryParameters2D *instance;
	VariantAdapter *adapter;
	JSClassID opaque_id;
    // Allow constructing from an existing native pointer
    if (argc == 1 && VariantAdapter::can_cast(argv[0], Variant::Type::OBJECT)) {
		adapter = static_cast<VariantAdapter *>(JS_GetAnyOpaque(*argv, &opaque_id));
		instance = static_cast<NavigationPathQueryParameters2D *>(VariantAdapter(*argv).get().operator Object *());
    } else {
        instance = memnew(NavigationPathQueryParameters2D);
...
static JSValue navigation_path_query_parameters2d_class_set_pathfinding_algorithm(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    ...
    return call_builtin_method_no_ret(&NavigationPathQueryParameters2D::set_pathfinding_algorithm, ctx, this_val, argc, argv);
};
...
static JSValue navigation_path_query_parameters2d_class_set_path_postprocessing(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&NavigationPathQueryParameters2D::set_path_postprocessing, ctx, this_val, argc, argv);
};
...
static JSValue navigation_path_query_parameters2d_class_set_map(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&NavigationPathQueryParameters2D::set_map, ctx, this_val, argc, argv);
};
static JSValue navigation_path_query_parameters2d_class_get_map(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	...
	proxy->getter = [this_val]() -> RID {
		NavigationPathQueryParameters2D *obj = static_cast<NavigationPathQueryParameters2D *>(VariantAdapter(this_val).get().operator Object*());
		return obj->get_map();
	};
	proxy->setter = [this_val](const RID &value) -> void {
		NavigationPathQueryParameters2D *js_proxy = static_cast<NavigationPathQueryParameters2D *>(VariantAdapter(this_val).get().operator Object *());
...
static JSValue navigation_path_query_parameters2d_class_set_start_position(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&NavigationPathQueryParameters2D::set_start_position, ctx, this_val, argc, argv);
};
...
static JSValue navigation_path_query_parameters2d_class_set_target_position(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&NavigationPathQueryParameters2D::set_target_position, ctx, this_val, argc, argv);
};
...
static JSValue navigation_path_query_parameters2d_class_set_navigation_layers(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&NavigationPathQueryParameters2D::set_navigation_layers, ctx, this_val, argc, argv);
};
...
static JSValue navigation_path_query_parameters2d_class_set_metadata_flags(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&NavigationPathQueryParameters2D::set_metadata_flags, ctx, this_val, argc, argv);
};
...
static JSValue navigation_path_query_parameters2d_class_set_simplify_path(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&NavigationPathQueryParameters2D::set_simplify_path, ctx, this_val, argc, argv);
};
...
static JSValue navigation_path_query_parameters2d_class_set_simplify_epsilon(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&NavigationPathQueryParameters2D::set_simplify_epsilon, ctx, this_val, argc, argv);
};
...
static JSValue navigation_path_query_parameters2d_class_set_included_regions(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&NavigationPathQueryParameters2D::set_included_regions, ctx, this_val, argc, argv);
};
static JSValue navigation_path_query_parameters2d_class_get_included_regions(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
	return call_builtin_const_method_ret(&NavigationPathQueryParameters2D::get_included_regions, ctx, this_val, argc, argv);
}
static JSValue navigation_path_query_parameters2d_class_set_excluded_regions(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&NavigationPathQueryParameters2D::set_excluded_regions, ctx, this_val, argc, argv);
};
static JSValue navigation_path_query_parameters2d_class_get_excluded_regions(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
	return call_builtin_const_method_ret(&NavigationPathQueryParameters2D::get_excluded_regions, ctx, this_val, argc, argv);
}
static JSValue navigation_path_query_parameters2d_class_set_path_return_max_length(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&NavigationPathQueryParameters2D::set_path_return_max_length, ctx, this_val, argc, argv);
};
static JSValue navigation_path_query_parameters2d_class_get_path_return_max_length(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
	return call_builtin_const_method_ret(&NavigationPathQueryParameters2D::get_path_return_max_length, ctx, this_val, argc, argv);
}
static JSValue navigation_path_query_parameters2d_class_set_path_return_max_radius(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&NavigationPathQueryParameters2D::set_path_return_max_radius, ctx, this_val, argc, argv);
};
static JSValue navigation_path_query_parameters2d_class_get_path_return_max_radius(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
	return call_builtin_const_method_ret(&NavigationPathQueryParameters2D::get_path_return_max_radius, ctx, this_val, argc, argv);
}
static JSValue navigation_path_query_parameters2d_class_set_path_search_max_polygons(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&NavigationPathQueryParameters2D::set_path_search_max_polygons, ctx, this_val, argc, argv);
};
static JSValue navigation_path_query_parameters2d_class_get_path_search_max_polygons(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
	return call_builtin_const_method_ret(&NavigationPathQueryParameters2D::get_path_search_max_polygons, ctx, this_val, argc, argv);
}
static JSValue navigation_path_query_parameters2d_class_set_path_search_max_distance(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&NavigationPathQueryParameters2D::set_path_search_max_distance, ctx, this_val, argc, argv);
};
static JSValue navigation_path_query_parameters2d_class_get_path_search_max_distance(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
	return call_builtin_const_method_ret(&NavigationPathQueryParameters2D::get_path_search_max_distance, ctx, this_val, argc, argv);
}
...
static const JSCFunctionListEntry navigation_path_query_parameters2d_class_proto_funcs[] = {
	...
	JS_CFUNC_DEF("set_included_regions", 1, &navigation_path_query_parameters2d_class_set_included_regions),
	JS_CFUNC_DEF("get_included_regions", 0, &navigation_path_query_parameters2d_class_get_included_regions),
	JS_CFUNC_DEF("set_excluded_regions", 1, &navigation_path_query_parameters2d_class_set_excluded_regions),
	JS_CFUNC_DEF("get_excluded_regions", 0, &navigation_path_query_parameters2d_class_get_excluded_regions),
	JS_CFUNC_DEF("set_path_return_max_length", 1, &navigation_path_query_parameters2d_class_set_path_return_max_length),
	JS_CFUNC_DEF("get_path_return_max_length", 0, &navigation_path_query_parameters2d_class_get_path_return_max_length),
	JS_CFUNC_DEF("set_path_return_max_radius", 1, &navigation_path_query_parameters2d_class_set_path_return_max_radius),
	JS_CFUNC_DEF("get_path_return_max_radius", 0, &navigation_path_query_parameters2d_class_get_path_return_max_radius),
	JS_CFUNC_DEF("set_path_search_max_polygons", 1, &navigation_path_query_parameters2d_class_set_path_search_max_polygons),
	JS_CFUNC_DEF("get_path_search_max_polygons", 0, &navigation_path_query_parameters2d_class_get_path_search_max_polygons),
	JS_CFUNC_DEF("set_path_search_max_distance", 1, &navigation_path_query_parameters2d_class_set_path_search_max_distance),
	JS_CFUNC_DEF("get_path_search_max_distance", 0, &navigation_path_query_parameters2d_class_get_path_search_max_distance),
};




static void define_navigation_path_query_parameters2d_property(JSContext *ctx, JSValue proto) {
    ...
    JS_DefinePropertyGetSet(
        ...
        JS_NewCFunction(ctx, navigation_path_query_parameters2d_class_get_excluded_regions, "get_excluded_regions", 0),
        JS_NewCFunction(ctx, navigation_path_query_parameters2d_class_set_excluded_regions, "set_excluded_regions", 1),
        JS_PROP_GETSET
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, navigation_path_query_parameters2d_class_get_included_regions, "get_included_regions", 0),
        JS_NewCFunction(ctx, navigation_path_query_parameters2d_class_set_included_regions, "set_included_regions", 1),
        JS_PROP_GETSET
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, navigation_path_query_parameters2d_class_get_path_return_max_length, "get_path_return_max_length", 0),
        JS_NewCFunction(ctx, navigation_path_query_parameters2d_class_set_path_return_max_length, "set_path_return_max_length", 1),
        JS_PROP_GETSET
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, navigation_path_query_parameters2d_class_get_path_return_max_radius, "get_path_return_max_radius", 0),
        JS_NewCFunction(ctx, navigation_path_query_parameters2d_class_set_path_return_max_radius, "set_path_return_max_radius", 1),
        JS_PROP_GETSET
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, navigation_path_query_parameters2d_class_get_path_search_max_polygons, "get_path_search_max_polygons", 0),
        JS_NewCFunction(ctx, navigation_path_query_parameters2d_class_set_path_search_max_polygons, "set_path_search_max_polygons", 1),
        JS_PROP_GETSET
    );
    JS_DefinePropertyGetSet(
        ctx,
        ...
        JS_NewCFunction(ctx, navigation_path_query_parameters2d_class_get_path_search_max_distance, "get_path_search_max_distance", 0),
        JS_NewCFunction(ctx, navigation_path_query_parameters2d_class_set_path_search_max_distance, "set_path_search_max_distance", 1),
        JS_PROP_GETSET
    );
}
...
static int js_navigation_path_query_parameters2d_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	classes["NavigationPathQueryParameters2D"] = class_id;
	classes_by_id[class_id] = "NavigationPathQueryParameters2D";
	JS_NewClass(JS_GetRuntime(ctx), class_id, &navigation_path_query_parameters2d_class_def);
...
void __register_navigation_path_query_parameters2d() {
	js_init_navigation_path_query_parameters2d_module(js_context());
}

void register_navigation_path_query_parameters2d() {
	__register_navigation_path_query_parameters2d();
}