...
static void define_visual_shader_node_float_parameter_enum(JSContext *ctx, JSValue ctor) {
...
static int js_visual_shader_node_float_parameter_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_visual_shader_node_float_parameter_enum(ctx, ctor);
	JS_SetConstructor(ctx, ctor, proto);
	JS_SetModuleExport(ctx, m, "VisualShaderNodeFloatParameter", ctor);
	ctor_list["VisualShaderNodeFloatParameter"] = ctor;
