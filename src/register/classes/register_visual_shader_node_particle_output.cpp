...
static void define_visual_shader_node_particle_output_enum(JSContext *ctx, JSValue ctor) {
}
...
static int js_visual_shader_node_particle_output_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_visual_shader_node_particle_output_enum(ctx, ctor);
	JS_SetConstructor(ctx, ctor, proto);
	JS_SetModuleExport(ctx, m, "VisualShaderNodeParticleOutput", ctor);
	ctor_list["VisualShaderNodeParticleOutput"] = ctor;
