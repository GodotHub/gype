...
static void define_open_xr_composition_layer_cylinder_enum(JSContext *ctx, JSValue ctor) {
}
...
static int js_open_xr_composition_layer_cylinder_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_open_xr_composition_layer_cylinder_enum(ctx, ctor);
	JS_SetConstructor(ctx, ctor, proto);
	JS_SetModuleExport(ctx, m, "OpenXRCompositionLayerCylinder", ctor);
	ctor_list["OpenXRCompositionLayerCylinder"] = ctor;
