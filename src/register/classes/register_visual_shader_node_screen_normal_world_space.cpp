...
static void define_visual_shader_node_screen_normal_world_space_enum(JSContext *ctx, JSValue ctor) {
}
...
static int js_visual_shader_node_screen_normal_world_space_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_visual_shader_node_screen_normal_world_space_enum(ctx, ctor);
