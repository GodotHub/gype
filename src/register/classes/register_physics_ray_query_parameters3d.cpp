...
static void physics_ray_query_parameters3d_class_finalizer(JSRuntime *rt, JSValue val) {
	JSClassID class_id = classes["PhysicsRayQueryParameters3D"];
...
static JSClassDef physics_ray_query_parameters3d_class_def = {
    ...
    physics_ray_query_parameters3d_class_finalizer
};
...
static JSValue physics_ray_query_parameters3d_class_constructor(JSContext *ctx, JSValueConst new_target, int argc, JSValueConst *argv) {
    ...
    PhysicsRayQueryParameters3D *instance;
	VariantAdapter *adapter;
	JSClassID opaque_id;
    // Allow constructing from an existing native pointer
    if (argc == 1 && VariantAdapter::can_cast(argv[0], Variant::Type::OBJECT)) {
		adapter = static_cast<VariantAdapter *>(JS_GetAnyOpaque(*argv, &opaque_id));
		instance = static_cast<PhysicsRayQueryParameters3D *>(VariantAdapter(*argv).get().operator Object *());
    } else {
        instance = memnew(PhysicsRayQueryParameters3D);
...
static JSValue physics_ray_query_parameters3d_class_set_from(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    ...
    return call_builtin_method_no_ret(&PhysicsRayQueryParameters3D::set_from, ctx, this_val, argc, argv);
};
static JSValue physics_ray_query_parameters3d_class_get_from(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	...
	proxy->getter = [this_val]() -> Vector3 {
		PhysicsRayQueryParameters3D *obj = static_cast<PhysicsRayQueryParameters3D *>(VariantAdapter(this_val).get().operator Object*());
		return obj->get_from();
	};
	proxy->setter = [this_val](const Vector3 &value) -> void {
		PhysicsRayQueryParameters3D *js_proxy = static_cast<PhysicsRayQueryParameters3D *>(VariantAdapter(this_val).get().operator Object *());
...
static JSValue physics_ray_query_parameters3d_class_set_to(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&PhysicsRayQueryParameters3D::set_to, ctx, this_val, argc, argv);
};
...
static JSValue physics_ray_query_parameters3d_class_set_collision_mask(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&PhysicsRayQueryParameters3D::set_collision_mask, ctx, this_val, argc, argv);
};
static JSValue physics_ray_query_parameters3d_class_get_collision_mask(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
	return call_builtin_const_method_ret(&PhysicsRayQueryParameters3D::get_collision_mask, ctx, this_val, argc, argv);
}
static JSValue physics_ray_query_parameters3d_class_set_exclude(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&PhysicsRayQueryParameters3D::set_exclude, ctx, this_val, argc, argv);
};
static JSValue physics_ray_query_parameters3d_class_get_exclude(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
	return call_builtin_const_method_ret(&PhysicsRayQueryParameters3D::get_exclude, ctx, this_val, argc, argv);
}
static JSValue physics_ray_query_parameters3d_class_set_collide_with_bodies(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&PhysicsRayQueryParameters3D::set_collide_with_bodies, ctx, this_val, argc, argv);
};
static JSValue physics_ray_query_parameters3d_class_is_collide_with_bodies_enabled(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
	return call_builtin_const_method_ret(&PhysicsRayQueryParameters3D::is_collide_with_bodies_enabled, ctx, this_val, argc, argv);
}
static JSValue physics_ray_query_parameters3d_class_set_collide_with_areas(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&PhysicsRayQueryParameters3D::set_collide_with_areas, ctx, this_val, argc, argv);
};
static JSValue physics_ray_query_parameters3d_class_is_collide_with_areas_enabled(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
	return call_builtin_const_method_ret(&PhysicsRayQueryParameters3D::is_collide_with_areas_enabled, ctx, this_val, argc, argv);
}
static JSValue physics_ray_query_parameters3d_class_set_hit_from_inside(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&PhysicsRayQueryParameters3D::set_hit_from_inside, ctx, this_val, argc, argv);
};
static JSValue physics_ray_query_parameters3d_class_is_hit_from_inside_enabled(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
	return call_builtin_const_method_ret(&PhysicsRayQueryParameters3D::is_hit_from_inside_enabled, ctx, this_val, argc, argv);
}
static JSValue physics_ray_query_parameters3d_class_set_hit_back_faces(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
    return call_builtin_method_no_ret(&PhysicsRayQueryParameters3D::set_hit_back_faces, ctx, this_val, argc, argv);
};
static JSValue physics_ray_query_parameters3d_class_is_hit_back_faces_enabled(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	CHECK_INSTANCE_VALID_V(this_val);
	return call_builtin_const_method_ret(&PhysicsRayQueryParameters3D::is_hit_back_faces_enabled, ctx, this_val, argc, argv);
}
static JSValue physics_ray_query_parameters3d_class_create(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
	return call_builtin_static_method_ret(&PhysicsRayQueryParameters3D::create, ctx, this_val, argc, argv);
};
...
static void define_physics_ray_query_parameters3d_property(JSContext *ctx, JSValue proto) {
...
static void define_physics_ray_query_parameters3d_enum(JSContext *ctx, JSValue proto) {
}

static int js_physics_ray_query_parameters3d_class_init(JSContext *ctx, JSModuleDef *m) {	
	JSClassID class_id = 0;
	class_id = JS_NewClassID(js_runtime(), &class_id);
	classes["PhysicsRayQueryParameters3D"] = class_id;
	classes_by_id[class_id] = "PhysicsRayQueryParameters3D";
	JS_NewClass(JS_GetRuntime(ctx), class_id, &physics_ray_query_parameters3d_class_def);
	...
	define_physics_ray_query_parameters3d_property(ctx, proto);
	define_physics_ray_query_parameters3d_enum(ctx, proto);
...
void __register_physics_ray_query_parameters3d() {
	js_init_physics_ray_query_parameters3d_module(js_context());
}

void register_physics_ray_query_parameters3d() {
	__register_physics_ray_query_parameters3d();
}