...
export declare class NavigationServer3D extends GodotObject {
    ...
    public query_path(parameters: NavigationPathQueryParameters3D, result: NavigationPathQueryResult3D, callback: Callable = Callable()): void;
    ...
    public bake_from_source_geometry_data_async(navigationMesh: NavigationMesh, sourceGeometryData: NavigationMeshSourceGeometryData3D, callback: Callable = Callable()): void;
