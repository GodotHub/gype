...
static void define_visual_shader_node_u_int_op_enum(JSContext *ctx, JSValue ctor) {
...
static int js_visual_shader_node_u_int_op_class_init(JSContext *ctx, JSModuleDef *m) {	
	...
	define_visual_shader_node_u_int_op_enum(ctx, ctor);
	JS_SetConstructor(ctx, ctor, proto);
	JS_SetModuleExport(ctx, m, "VisualShaderNodeUIntOp", ctor);
	ctor_list["VisualShaderNodeUIntOp"] = ctor;
